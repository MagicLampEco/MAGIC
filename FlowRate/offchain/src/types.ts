...
export interface FlowRateDatum {
  ema_fast_q: bigint;        // Fast EMA, Q-format (oildrop/nanogic × Q)
  ema_slow_q: bigint;        // Slow EMA, Q-format
  lamp_per_magic_q: bigint;  // Current output rate, Q-format
  total_lamp_epoch: bigint;  // Last epoch Σ global_lamp_epoch (oildrop)
...
export interface EpochFlow {
  total_lamp_oildrop: bigint;    // Σ global_lamp_epoch across ALL apps
