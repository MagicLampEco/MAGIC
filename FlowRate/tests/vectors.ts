...
//
// Q-format rate: lamp_per_magic_q = total_lamp_oildrop × Q / total_magic_ng
//
// Examples at MIN_MAGIC_EPOCH = 10^12 nanogic (1000 MAGIC minimum per epoch):
//   0.1 LAMP/MAGIC → lamp_per_magic_q = 100_000_000 (= Q/10)
//     total_lamp_oildrop = 10^8 × 10^12 / 10^9 = 10^11  → 100_000_000_000
//   0.2 LAMP/MAGIC → lamp_per_magic_q = 200_000_000 (= Q/5)
//     total_lamp_oildrop = 10^8 × 2 × 10^12 / 10^9    → 200_000_000_000
//   0.5 LAMP/MAGIC → lamp_per_magic_q = 500_000_000 (= Q/2)
//     total_lamp_oildrop = 5 × 10^11                   → 500_000_000_000
...
export const TV_FR_STABLE = {
  flow: {
    total_lamp_oildrop: 100_000_000_000n,  // 10^11 oildrop → rate_q = 100M
...
export const TV_FR_GENUINE_CHANGE_FLOW = {
  total_lamp_oildrop: 200_000_000_000n,  // rate_q = 200M (0.2 LAMP/MAGIC)
  total_magic_ng: BASE_MAGIC_NG,
};
...
export const TV_FR_MANIP_1EPOCH = {
  flow: {
    total_lamp_oildrop: 500_000_000_000n,  // rate_q = 500M (0.5 LAMP/MAGIC)
    total_magic_ng: BASE_MAGIC_NG,
    epoch: 1,
  },
...
export const TV_FR_MANIP_6EPOCH_FLOW = {
  total_lamp_oildrop: 500_000_000_000n,  // rate_q = 500M
  total_magic_ng: BASE_MAGIC_NG,
};
...
export const TV_FR_ZERO_MAGIC = {
  flow: { total_lamp_oildrop: 0n, total_magic_ng: 0n, epoch: 1 },
};
...
// total_lamp_oildrop=1 (non-zero passes the lamp guard), total_magic_ng=10^12 (above threshold)
export const TV_FR_FLOOR = {
  flow: { total_lamp_oildrop: 1n, total_magic_ng: BASE_MAGIC_NG, epoch: 1 },
...
export const TV_FR_OVERFLOW = {
  flow: {
    total_lamp_oildrop: 10_000_000_000_000_000n,  // 10^16 oildrop
...
//   lamp_oildrop = 204_800 nanogic × 100_000_000 / Q = 20_480 oildrop
export const TV_FR_LAMPNET = {
  kb_per_mb: 1024n,
  perm_nanogic_per_kb: 200n,
  magic_for_1mb_perm: 1024n * 200n,  // = 204_800 nanogic
  lamp_cap_at_rate_01: 1024n * 200n * 100_000_000n / Q,  // = 20_480 oildrop
};
