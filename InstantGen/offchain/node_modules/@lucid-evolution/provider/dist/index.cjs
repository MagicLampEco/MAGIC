...
var RewardAccountSummarySchema = import_effect2.Schema.Struct({
  from: import_effect2.Schema.optional(import_effect2.Schema.Literal("key", "script")),
...
var Kupmios = class {
  ...
  async getProtocolParameters() {
    ...
    const response = await (0, import_effect6.pipe)(
      makePostAsJson(
        this.ogmiosUrl,
        data,
        schema,
  ...
  async getUtxos(addressOrCredential) {
    ...
    const utxos = await (0, import_effect6.pipe)(
      ...
      import_effect6.Effect.flatMap(
        (u) => kupmiosUtxosToUtxos(this.kupoUrl, u, this.headers?.kupoHeader)
      ),
      import_effect6.Effect.timeout(1e4),
      import_effect6.Effect.catchAll((cause) => new KupmiosError({ cause })),
      import_effect6.Effect.provide(import_platform2.FetchHttpClient.layer),
