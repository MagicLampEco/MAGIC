...
// VacuumGen/onchain/lib/magiclamp/protocol/types.ak (P8 invariant).
export const VaultRedeemerSchema = Data.Enum([
  Data.Object({ VacuumCommit: Data.Object({ lambda: Data.Integer() }) }),    // constr 0
  Data.Object({ VacuumFire:   Data.Object({ order_id: Data.Bytes() }) }),    // constr 1
  Data.Object({ InstantGen:   Data.Object({ lamp_paid: Data.Integer() }) }), // constr 2
  Data.Literal("ApplyHalving"),                                              // constr 3
  Data.Object({ BurnBatch: Data.Object({                                     // constr 4
