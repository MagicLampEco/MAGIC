...
>
> 1. **`backingBeaconUtxo` chưa tồn tại.** Nó là bắt buộc; chừng nào chưa có BackingBeacon
>    thì không reference input nào thoả, `cap_surplus` không tính được, tx bị từ chối.
